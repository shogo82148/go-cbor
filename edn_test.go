...
func TestDecodeEDN(t *testing.T) {
	tests := []struct {
		...
		{
			in:  `{1: 2, 3: 4}`,
			out: RawMessage{0xa2, 0x01, 0x02, 0x03, 0x04},
		},
		{
			in:  `{"a": 1, "b": [2, 3]}`,
			out: RawMessage{0xa2, 0x61, 0x61, 0x01, 0x61, 0x62, 0x82, 0x02, 0x03},
		},
		{
			in:  `["a", {"b": "c"}]`,
			out: RawMessage{0x82, 0x61, 0x61, 0xa1, 0x61, 0x62, 0x61, 0x63},
		},
		{
